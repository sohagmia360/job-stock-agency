...
const Footer: NextPage = () => {
  return (
    <div className="mt-28 bg-[#F5FBF6] pt-16">
        ...
        <div className="flex lg:items-center lg:justify-center">
          <div>
            <h2 className="text-2xl mb-3 font-semibold">
              <span className="font-bold text-light_green">Job</span> Stock
            </h2>
        ...
        <div className="flex lg:items-center lg:justify-center">
          <div>
            ...
            <div className="flex flex-col gap-3 text-light_gray_white">
              ...
              <span>
                <Link href="/">Candidate Listing</Link>
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="flex lg:items-center lg:justify-center">
          <div>
            ...
            <div className="flex flex-col gap-3 text-light_gray_white">
              ...
              <span>
                <Link href="/">Employer Listing</Link>
              </span>
              <span>
                <Link href="/">Post New Job</Link>
              </span>
              <span>
                <Link href="/">All Employers</Link>
              </span>
              <span>
      ...
      <p className="bg-light_green text-center p-4 text-light_white mt-10">
        © 2022 JobStock. All Rights Reserved by{" "}
        <span className="font-bold">Sohag Hossain Zayan</span>
      </p>
    </div>
  );
};
